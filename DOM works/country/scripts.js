var countries=[
    ...
    {
      "name": "South Georgia and South Islands",
      "topLevelDomain": [
        ".gs"
      ],
      "alpha2Code": "GS",
        ...
        <div class="relative aspect-[16/9]  w-auto rounded-md md:aspect-auto md:h-[400px]">
          ...
          <div class="absolute bottom-4 left-4 text-left">
            ...
            <p class="mt-2 text-sm text-gray-300">
              Native Name is : ${c.nativeName}</p>
            <p class="mt-2 text-sm text-gray-300">
              Capital is : ${c.capital}</p>
            <p class="mt-2 text-sm text-gray-300">
              Continent is : ${c.region}</p>
            <p class="mt-2 text-sm text-gray-300">
              Population is : ${c.population}</p>
...
function filterCountryByName(event){

    let choice=event.target.value

    let item=countries.filter(c=>c.name==choice)

    displayCountries(item)
